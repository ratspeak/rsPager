...
void setup() {
  ...
  LoRa->setPins(pin_cs, pin_reset, pin_dio, pin_busy, pin_rxen, pin_txen);
    ...
    update_display();
      ...
      bt_init();
      bt_init_ran = true;
      #if (BOARD_MODEL == BOARD_CARDPUTER_ADV || BOARD_MODEL == BOARD_TDECK || BOARD_MODEL == BOARD_TPAGER) && HAS_BLE == true
...
void handleModemTimeout() {
  ...
  #if BOARD_MODEL == BOARD_CARDPUTER_ADV || BOARD_MODEL == BOARD_TPAGER
    stopRadio();
    delay(50);
    startRadio();
  #else
